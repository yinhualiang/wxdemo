<template>
	<div style="overflow: auto;height: 100%;background: #eee;text-align: left;">
		...
		<div class="my-cells" style="margin-top: 0px;">
			...
			<div class="weui-cell  weui-cell_select  myCell">
				<div class="weui-cell__hd"><span>验收区域</span></div>
				<div class="weui-cell__bd">
					<select class="weui-select" :readonly="isReadOnly" v-model="xiala.qy" @click='shopchange'   name="select1">
						<option v-for="shopitem in this.cation.shop" :value="shopitem.qy">{{shopitem.qy}}</option>
						
					</select>
				</div>
			</div>
			<div class="weui-cell weui-cell_select myCell" >
				<div class="weui-cell__hd"><span>店铺形象</span><span style="color:red">*</span></div>
				<div class="weui-cell__bd">
					<div class="weui-cell__bd myCell-bd" style="padding-top: 5px;padding-right: 10px;"  >
					<span>{{cation.xinxi.xxjb}}</span>
				</div>
				</div>
			</div>
			<div class="weui-cell weui-cell_select myCell" >
			...
			<div class="weui-cell myCell" >
				<div class="weui-cell__hd"><span>质量概述</span><span style="color:red">*</span></div>
				<div class="weui-cell__bd">
					<input class="weui-input" :readonly="isReadOnly"  style="text-align: right;width:90%;" v-model="mainData.zlgs" type="text">
				</div>
			</div> 
		</div>
