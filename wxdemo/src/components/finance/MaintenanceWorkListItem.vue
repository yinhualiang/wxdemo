	...
	<div style="overflow: auto;height: 100%;background: #eee;text-align: left;">
		...
		<div class="my-cells" style="margin-top: 0px;margin-bottom:15px;">
			<div class="weui-cell  weui-cell_select  myCell">
				<div class="weui-cell__hd"><span>维修类型</span></div>
			...
			<div class="weui-cell myCell">
				<div class="weui-cell__hd"><span>店铺地址</span></div>
				<div class="weui-cell__bd">
					<input class="weui-input" :readonly="isReadOnly"  style="text-align: right;" v-model="mainData.yfje" type="text">
				</div>
			</div>
			<div class="weui-cell myCell">
				<div class="weui-cell__hd"><span>店铺负责人</span></div>
				<div class="weui-cell__bd">
					<input class="weui-input" :readonly="isReadOnly"  style="text-align: right;" v-model="mainData.czy" type="text">
				</div>
			</div>
			<div class="weui-cell myCell">
				<div class="weui-cell__hd"><span>店铺电话</span></div>
				<div class="weui-cell__bd">
					<input class="weui-input" :readonly="isReadOnly"  style="text-align: right;" v-model="mainData.yfje" type="text">
				</div>
			</div>
            <div class="weui-cell myCell">
				<div class="weui-cell__hd"><span>对接人</span></div>
				<div class="weui-cell__bd">
					<input class="weui-input" :readonly="isReadOnly"  style="text-align: right;" v-model="mainData.czy" type="text">
				</div>
			</div>
			<div class="weui-cell myCell">
				<div class="weui-cell__hd"><span>联系电话</span></div>
				<div class="weui-cell__bd">
					<input class="weui-input" :readonly="isReadOnly"  style="text-align: right;" v-model="mainData.yfje" type="text">
				</div>
			</div>
            <div class="weui-cell  weui-cell_select  myCell">
				<div class="weui-cell__hd"><span>维修商</span></div>
				<div class="weui-cell__bd">
					<select class="weui-select" :readonly="isReadOnly" v-model="mainData.jsdw" name="select1">
						<option  value="满足">满足</option>
						<option  value="不满足">不满足</option>
            ...
            <div class="weui-cell myCell">
				<div class="weui-cell__hd"><span>维修商电话</span></div>
				<div class="weui-cell__bd">
					<input class="weui-input" :readonly="isReadOnly"  style="text-align: right;" v-model="mainData.yfje" type="text">
				</div>
			</div>
		...
		<span style="padding-left:4%;">明细1</span>
		<div class="my-cells" style='margin-top:10px;'>
			<!-- <div class="weui-cell  weui-cell_select  myCell">
				<div class="weui-cell__hd"><span>维修源</span></div>
				<div class="weui-cell__bd">
					<select class="weui-select" :readonly="isReadOnly" v-model="mainData.jsdw" name="select1">
						<option  value="满足">满足</option>
						<option  value="不满足">不满足</option>
			...
			<div class="weui-cell myCell">
				<div class="weui-cell__hd"><span>小类</span></div>
				<div class="weui-cell__bd">
					<input class="weui-input" :readonly="isReadOnly"  style="text-align: right;" v-model="mainData.yfje" type="text">
				</div>
			</div>
			...
			<div class="weui-cell myCell">
				<div class="weui-cell__hd"><span>问题定位</span></div>
				<div class="weui-cell__bd">
					<input class="weui-input" :readonly="isReadOnly"  style="text-align: right;" v-model="mainData.yfje" type="text">
				</div>
			</div>
            <div class="weui-cell myCell">
				<div class="weui-cell__hd"><span>问题描述</span></div>
				<div class="weui-cell__bd">
					<input class="weui-input" :readonly="isReadOnly"  style="text-align: right;" v-model="mainData.yfje" type="text">
				</div>
			</div>
