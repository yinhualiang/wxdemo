<template>
    <li>
        ...
        <ul v-show="open" v-if='isFolder'>
            <selectQuartersItems v-for='(cel,key,index) in model.children' :radioSelectFlags="radioSelectFlags" :orgUsersObj="orgUsersObj" @messageOut="messageIn" :level='level+1' :parent='model' :key='cel.id' :model='cel'></selectQuartersItems>
        </ul>
    </li>
</template>
    ...
    methods: {
        ...
        checked: function(mt) {
           // console.log(1111)
            ...
            // }
            //console.info(this.radioSelectFlags);
            //console.info(this.orgUsersObj);
            if (this.radioSelectFlags ) {
        ...
        bacthUpdateChild: function(model) {
            ...
            //console.info(model.childComponents);
            // console.log(this.model.children && this.model.children.length&&this.model.checked)

            //    if(this.model.children.length!=undefined&&this.children.length<1){
            //    debugger
            // console.debug(this.model.children);
            // console.log(this.model.children==undefined)
            // {
            //     console.log(1111111)
