<template>
  <div>
    ...
    <div @click="util.gotoByPath('/workflow/approval',{query:{type:'finished'}})" style="overflow: hidden;" class="ibox">
    ...
    <div @click="util.gotoByPath('/workflow/copy',{query:{type:'finished'}})" style="overflow: hidden;" class="ibox">
