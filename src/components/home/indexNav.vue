<template>
    <div class="index-nav" style="padding-bottom: 50px!important;">
        <div class="page-index">
            <swiper loop auto height='180px' :list="demo07_list" :index="demo07_index" @on-index-change="demo07_onIndexChange"></swiper>
            <nav>
                <div class="if-backlog">
                    <ul>
                        <li>
                            <a @click="util.gotoByPath('/workflow/desktop')">请示审批</a>
                        </li>
                        <li>
                            <a @click="util.gotoByPath('/workflow/approval',{type:'unFinished'})">待办({{myApprovalUnFinishedCount}})</a>
                        </li>
                        <li>
                            <a @click="util.gotoByPath('/workflow/copy',{type:'unFinished'})">待阅({{myCopyUnFinishedCount}})</a>
                        </li>
                        <li>
                            <a @click="util.gotoByPath('/workflow/apply')">我申请的({{myApplyAllCount}})</a>
                        </li>
                        <li>
                            <a @click="util.gotoByPath('/workflow/approval',{type:'finished'})">我的已办({{myApprovalFinishedCount}})</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="use-list">
                    <ul>
                        ...
                        <li  v-for="(item,index) in shortCutList" :value="item.value" :key="index">
        ...
        <div class="page-app">
            ...
            <div v-for="(items,index) in appList" :key="index" style="margin-bottom: 10px;">
                <div class="caption">
        ...
        <div class="page-user">
            ...
            <div class="message1 message" style="margin-top:0px">
                <div style="position:relative" @click="goto('attRecord')">
                    <i class="glyphicon glyphicon-map-marker iconStyle" style="color:#3774d2"></i>
                    <p class="user-button">
                        <span class="fl" style="padding-left: 8px;">考勤记录</span>
                    </p>
                </div>
                <div style="position:relative;display:none;">
                    <i class="glyphicon glyphicon-cd fl iconStyle" style="color:#336666"></i>
                    <p class="user-button">
                        <span class="fl" style="padding-left: 8px;">在线帮助</span>
                    </p>
                </div>
                <div style="position:relative" @click="clear()">
                    <i class="glyphicon glyphicon-refresh iconStyle" style="color:#663333"></i>
                    <p class="user-button">
            ...
            <div class="message2 message">
                <div style="position:relative" @click="aboutZhuzhu()">
                    <i class="glyphicon glyphicon-phone-alt iconStyle" style="color:#003366"></i>
                    <p class="user-button">
                        <span class="fl" style="padding-left: 8px;">关于</span>
                    </p>
                </div>
                <div style="position:relative">
                    <i class="glyphicon glyphicon-qrcode iconStyle" style="color:#666699"></i>
                    <p>
                        <span class="fl" style="padding-left: 8px;">当前版本号</span>
                        <span class="user-versions fr" style="font-family:'microsoft'">V{{versions}}</span>
                    </p>
                </div>
            </div>
        </div>
        <footer>
                ...
                <div class="page__bd" style="height: 100%;">
                    <div class="weui-tab">
                        ...
                        <div class="weui-tabbar">
                            <a href="javascript:;" @click="tabPage('首页')" class="weui-tabbar__item weui-tabbar__item1 weui-bar__item_on">
                            ...
                            <a href="javascript:;" @click="tabPage('项目')" class="weui-tabbar__item weui-tabbar__item2">
                                <svg class="icon weui-tabbar__icon" aria-hidden="true">
                                    <use xlink:href="#icon-xiangmu"></use>
                                </svg>
                                <p class="weui-tabbar__label">项目</p>
                            </a>
                            <a href="javascript:;" @click="tabPage('应用')" class="weui-tabbar__item weui-tabbar__item3">
                                <span style="display: inline-block;position: relative;">
                                    <svg class="icon weui-tabbar__icon" aria-hidden="true">
                                        <use xlink:href="#icon-shuju-"></use>
                                    </svg>
                                    <span class="weui-badge weui-badge_dot" style="position: absolute;top: 0;right: -6px;display:none;"></span>
                                </span>
                                <p class="weui-tabbar__label">应用</p>
                            </a>
                            <a href="javascript:;" @click="tabPage('个人')" class="weui-tabbar__item weui-tabbar__item4">
                                <svg class="icon weui-tabbar__icon" aria-hidden="true">
         ...
         <div v-transfer-dom>
				<popup v-model="iframePopupShow" position="right" style="width: 100%;padding-bottom:0px;">
					<div style="width:100%;    height: 100%;">
						<IframeShow :model="iframeData" ref="iframeShow" style="margin-bottom: 44px;"></IframeShow>
						<a href="javascript:;" @click="iframePopupShow = false;$refs.iframeShow.hide();" class="weui-btn weui-btn_warn" style="position: fixed;bottom: 0px;width: 100%;">关闭</a>
					</div>
    ...
    [
        ...
        },
        {
            ...
            children: [
                ...
                //     appId: '01',
                //     appName: '企业设置',
                //     iconCls: '/wechat/images/icons/property.png',
                //     name: 'sys/manager'
                // }
            ]
        }
...
export default {
    components: {
        Swiper,
        SwiperItem, Blur, ProjectList, Popup, TransferDom,IframeShow
    },
    directives: {
        TransferDom
    },
    ...
    created() {
        ...
        //加载自定义配置
this.util.post('/admin/appAgentAction!runAgent.action?agentId=Agent_WeChat_Sys&appId=WeChat&operateType=getApp',null,function(res){
...
<style>
.page-index .vux-slider>.vux-swiper>.vux-swiper-item>a>.vux-swiper-desc {
    padding: 10px 0;
    bottom: auto;
    top: 0;
    height: auto;
