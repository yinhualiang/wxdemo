<template>
	<div style="overflow: auto;height: 100%;background: #eee;text-align: left;">
		...
		<div class="my-cells" style="margin-top: 0px;">
			...
			<div class="weui-cell weui-cell_select myCell" style='display:none;'>
		...
		<!-- <div class="my-cells" style="display:none;">
			...
			<div class="weui-cell myCell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" :readonly="isReadOnly"  style="float:left;width:30%;border-bottom:1px solid #000;text-align:center;" v-model="mainData.jdwcqk" type="text"><span style='float:left;'>%</span>
				</div>
			</div>
			<div class="weui-cell myCell">
				...
				<div v-for="xiala in xialas" >
					...
					<div v-show='xiala.show'>
						...
						<div class="weui-cell myCell" >
							...
							<div class="weui-cell__bd">
								<input class="weui-input" :readonly="isReadOnly"  style="text-align: right;width:90%;" v-model="xiala.tp" type="text">
							</div>
						</div>
...
export default {
	...
	activated() {
		...
		this.id = id;
		this.mainData.ysrq=new Date().format("yyyy-MM-dd");
		this.loadData();
	},
	components: {
		// 名字
	...
	methods: {
		...
		saveData(flag){
			...
			this.mianData.jdwcqk='1、外立面改造施工完成     %;2、墙体轻质砖砌筑完成     %;3、地砖铺设完成     %;4、轻钢龙骨隔墙完成     %;5、轻钢龙骨隔墙墙面封板完成     %;6、天花吊顶主副龙骨铺设完成     %;7、天花封板施工完成     %;8、强电系统（含应急系统、防盗系统）布线施工完成     %;9、系统（含网络、监控、音响）布线施工完成      %;10、空调系统（含风机盘管主机、风管、电源及控制电路）施工完成     %;11、消防系统（含喷淋、消防栓改造；烟感系统改造）改造施工完成    %.'
			this.mainData.userId=this.userId;
			this.mainData.ysr=this.userName;
