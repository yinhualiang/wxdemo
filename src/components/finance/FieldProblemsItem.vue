	...
	<div style="overflow: auto;height: 100%;background: #eee;text-align: left;">
		...
		<div class="my-cells" style="margin-top: 0px;">
			<div class="weui-cell myCell">
				<div class="weui-cell__hd"><span>项目名称</span></div>
			...
			<div class="weui-cell myCell">
				...
				<div class="weui-cell__bd">
					<input class="weui-input" :readonly="isReadOnly"  style="text-align: right;" v-model="mainData.xmbh" type="text">
				</div>
			</div>
			<div class="weui-cell myCell">
				<div class="weui-cell__hd"><span>验收人</span></div>
				<div class="weui-cell__bd">
			...
			<div class="weui-cell myCell" >
				...
				<div class="weui-cell__bd">
					<datetime title="" class="be-check no-line" :readonly="isReadOnly" v-model="mainData.cfrq" style="padding:0px;padding-right:0px;height:100%;line-height:44px;" default-selected-value="date" format="YYYY-MM-DD" placeholder="请选择日期"></datetime>
				</div>
			</div> 
		...
		<div class="my-cells">
			...
			<div class="weui-cell weui-cell_select myCell">
				<div class="weui-cell__hd"><span>问题反馈1</span><span style="color:red">*</span></div>
				<div class="weui-cell__bd myCell-bd" style="line-height: 26px;" >
					<select class="weui-select" :readonly="isReadOnly" v-model="mainData.CATEGORY_" name="select1">
                        <option  value="采购入库">采购入库</option>
                        <option  value="直进直出">直进直出</option>
			...
			<div class="weui-cell myCell">
				<div class="weui-cell__hd"><span>现场问题说明</span></div>
				<div class="weui-cell__bd">
					<input class="weui-input" :readonly="isReadOnly"  style="text-align: right;" v-model="mainData.sn" type="text">
				</div>
			</div>
			<div class="weui-cell myCell">
				<div class="weui-cell__hd"><span>反馈确认</span></div>
				<div class="weui-cell__bd">
					<input class="weui-input" :readonly="isReadOnly"  style="text-align: right;" v-model="mainData.sn" type="text">
				</div>
			</div>
		...
		<div class="my-cells">
			<div class="weui-cell weui-cell_select myCell">
				<div class="weui-cell__hd"><span>问题反馈2</span><span style="color:red">*</span></div>
				<div class="weui-cell__bd myCell-bd" style="line-height: 26px;" >
					<select class="weui-select" :readonly="isReadOnly" v-model="mainData.CATEGORY_" name="select1">
                        <option  value="采购入库">采购入库</option>
                        <option  value="直进直出">直进直出</option>
...
export default {
	...
	components: {
		// 名字
		Attachment,SelectUser,Datetime,selectQuarters,VoiceRecognition,SelectProj
	},
	computed: {
		...mapState({
