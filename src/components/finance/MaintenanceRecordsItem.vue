	...
	<div style="overflow: auto;height: 100%;background: #eee;text-align: left;">
		...
		<div class="my-cells" style="margin-top: 0px;">
			<div class="weui-cell  weui-cell_select  myCell">
				<div class="weui-cell__hd"><span>区域</span></div>
			...
			<div class="weui-cell  weui-cell_select  myCell">
				<div class="weui-cell__hd"><span>保养类型</span></div>
				<div class="weui-cell__bd">
					<select class="weui-select" :readonly="isReadOnly" v-model="mainData.jsdw" name="select1">
						<option  value="满足">满足</option>
						<option  value="不满足">不满足</option>
			...
			<div class="weui-cell  weui-cell_select  myCell">
				<div class="weui-cell__hd"><span>设备编号</span></div>
				<div class="weui-cell__bd">
					<select class="weui-select" :readonly="isReadOnly" v-model="mainData.jsdw" name="select1">
						<option  value="满足">满足</option>
						<option  value="不满足">不满足</option>
		...
		<div class="my-cells">
			<!-- <div class="weui-cell weui-cell_select myCell" style="width:100%">
				<div class="weui-cell__hd"><span>项目</span></div>
				<div class="weui-cell__bd myCell-bd" style="padding-top: 5px;padding-right: 10px;" @click="isReadOnly? '':selectProj(selectProjModel)">
					<span>{{selectProjModel.xmmc}}</span>
				</div>
			</div> -->
			<div class="weui-cell myCell">
				<div class="weui-cell__hd"><span>设备名称</span></div>
				<div class="weui-cell__bd">
					<input class="weui-input" :readonly="isReadOnly"  style="text-align: right;" v-model="mainData.yfje" type="text">
				</div>
			</div>
			<div class="weui-cell myCell">
				<div class="weui-cell__hd"><span>品牌</span></div>
				<div class="weui-cell__bd">
					<input class="weui-input" :readonly="isReadOnly"  style="text-align: right;" v-model="mainData.jzje" type="text">
				</div>
			</div>
			<div class="weui-cell myCell" >
				<div class="weui-cell__hd"><span>包养时间</span><span style="color:red">*</span></div>
				<div class="weui-cell__bd">
		...
		<div class="my-cells">
			<div class="weui-cell myCell">
				<div class="weui-cell__hd"><span>包养情况</span></div>
				<div class="weui-cell__bd">
					<input class="weui-input" :readonly="isReadOnly"  style="text-align: right;" v-model="mainData.pzh" type="text">
				</div>
			</div>
...
export default {
	...
	data() {
		return {
			selectProjModel:{projUid:"",selectProjVisible:false,projName:''},
			addressObj:{
	...
	methods: {
		...
		selectProjCallback(){
			this.mainData.SUBJECT_=this.selectProjModel.projName+"_"+new Date().format("yyyyMMdd")+"采购订单";
		},
		selectOutWorker(){
