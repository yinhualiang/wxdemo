	...
	<div style="overflow: auto;height: 100%;background: #eee;text-align: left;">
		...
		<div class="my-cells" style="margin-top: 0px;">
			...
			<div class="weui-cell weui-cell_select myCell" style="padding-left:15px;">
				<div class="weui-cell__hd"><span>出差人<span style="color:red">*</span></span></div>
		...
		<div class="my-cells">
			<div class="weui-cell weui-cell_select myCell">
				...
				<div class="weui-cell__bd" style="padding-right: 5px;" @click="selectDepart()">
					<!-- <input class="weui-input" :readonly="isReadOnly"  style="text-align: right;" v-model="mainData.depart" type="text"> -->
			...
			<div class="weui-cell myCell">
				<div class="weui-cell__hd"><span>出差天数<span style="color:red">*</span></span></div>
				<div class="weui-cell__bd">
					<input class="weui-input" :readonly="isReadOnly"  style="text-align: right;" v-model="mainData.ccts" type="number">
				</div>
			</div>
		</div>
		...
		<div class="my-cells">
			<div class="weui-cell myCell" >
				<div class="weui-cell__hd"><span>出差日期</span></div>
				<div class="weui-cell__bd">
			...
			<div class="weui-cell myCell" style="text-align:left;overflow: hidden;">
				<div class="weui-cell__hd"><span>出差地点</span></div>
			...
			<div class="weui-cell myCell" >
				<div class="weui-cell__hd"><span>开始时间</span></div>
				<div class="weui-cell__bd">
					<datetime title="" class="be-check no-line" :readonly="isReadOnly" v-model="mainData.ksrq" style="padding:0px;padding-right:0px;height:100%;line-height:44px;" default-selected-value="date" format="YYYY-MM-DD HH:mm" placeholder="请选择日期"></datetime>
				</div>
			</div>
			<div class="weui-cell myCell" >
				<div class="weui-cell__hd"><span>结束时间</span></div>
				<div class="weui-cell__bd">
					<datetime title="" class="be-check no-line" :readonly="isReadOnly" v-model="mainData.jsrq" style="padding:0px;padding-right:0px;height:100%;line-height:44px;" default-selected-value="date" format="YYYY-MM-DD HH:mm" placeholder="请选择日期"></datetime>
				</div>
			</div>
			<div class="weui-cell myCell">
...
export default {
	...
	activated() {
		...
		this.util.init(this);
		this.mainData={czy:this.userName,fsrq:new Date().format("yyyy-MM-dd"),ksrq:new Date().format("yyyy-MM-dd hh:mm"),jsrq:''};
	...
	methods: {
		...
		saveData(flag){
			...
			var _this=this;
			this.util.mask('正在保存...');
			var params = { sqlTableName: "G001_rsgl_ccsqb", mainFormData: JSON.stringify(this.mainData), filesData: JSON.stringify(filesData), deleteFilesData: _this.attachmentModel.deleteFilesList.join(",") };
